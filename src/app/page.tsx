...
import { submitEditRequest, checkStatus } from '@/lib/api';
import { API_BASE_URL, API_KEY } from '@/lib/constants';
import { Status, StatusResponse, EditConfig } from '@/lib/types';
    ...
    const pollStatus = useCallback(async () => {
        ...
        try {
            ...
            if (data.status === 'success' && data.file_name) {
                setResultImageUrl(`${API_BASE_URL}/api/download/${data.file_name}`);
                setProcessId(null);
